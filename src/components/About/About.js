    ...
    <div className="about-container">
      <div className="container-text">
        ...
        <p>
          ...
          knowing the distance of Buenos Aires buses from your location, both in
          time and meters. This application leverages the transportation API
          provided by the City of Buenos Aires, which offers real-time
          information about the current positions of all the buses in the city.
        </p>
        <p>
